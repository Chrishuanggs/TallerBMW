...
public class OrdenServicioController {
    ...
    public void crear(String descripcion, int idVehiculo, int idMecanico, Usuario recepcionista) throws SQLException {
        ...
        if (idVehiculo <= 0)
            throw new IllegalArgumentException("Selecciona un vehiculo");
        if (idMecanico <= 0)
            throw new IllegalArgumentException("Selecciona un mecanico");
    ...
    public void cambiarEstado(int id, String nuevoEstado) throws SQLException {
        List<String> validos = List.of("PENDIENTE", "EN_PROCESO", "COMPLETADA", "CANCELADA");
    ...
    public void actualizarCosto(int id, String costoStr) throws SQLException {
        ...
        try {
            ...
            throw new IllegalArgumentException("El costo debe ser un numero valido");
        }
        if (costo < 0)
