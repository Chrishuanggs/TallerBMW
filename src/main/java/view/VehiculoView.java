...
public class VehiculoView extends JFrame {
    ...
    private JPanel buildFormulario() {
        ...
        JLabel lblForm = new JLabel("Datos del Vehículo");
        ...
        card.add(Box.createVerticalStrut(8));
        card.add(buildFieldGroup("Año *", txtAnio));
        card.add(Box.createVerticalStrut(8));
    ...
    private JScrollPane buildTabla() {
        String[] columnas = {"ID", "Placa", "Marca", "Modelo", "Año", "Color", "VIN", "Cliente"};
    ...
    private void buscar() {
        ...
        try {
            ...
            setStatus("Error al buscar: " + ex.getMessage(), DANGER);
        }
    }
